...
<script>
  (function() {
    ...
    var xValues = dataset.map(function(d, i) { return i; });
    ...
    var yScale = function(y) { return margin.top + height - ((y - minY) / (maxY - minY)) * height; };
    ...
    dataset.forEach(function(d, i) {
      ...
      circle.setAttribute('title', d.x + ': ' + d.y);
    ...
    if (xlabel) {
      ...
      xLabelText.setAttribute('y', margin.top + height + 25);
