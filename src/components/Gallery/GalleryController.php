...
class GalleryController extends \Opensitez\Simplicity\Component
{
    ...
    public function editPhoto($photoID = null)
    {
        ...
        $data['form_action'] = "?component=gallery&page=update_photo&photo_id=$photoID";
        $data['gallery_link'] = "?component=gallery&page=update_gallery&gallery_id=$galleryID";
    ...
    public function addGallery($galleryID, $app = [])
    {
            ...
            if (empty($title) || empty($description)) {
                ...
                if ($galleryID) {
                    ...
                    if ($updateStatus) {
                        ...
                        $data['form_action'] = "?component=gallery&page=add_gallery&gallery_id=$galleryID";
        ...
        if ($galleryID) {
            ...
            $data['form_action'] = "?component=gallery&page=update_gallery&gallery_id=$galleryID&site_id=$site_id";
        }
    ...
    public function listGalleries($params = [])
    {
        ...
        $masterTemplate = $this->substitute_vars($masterTemplate, [
            ...
            'message' => $message,
            'add_link' => "?component=gallery&page=add_gallery",
        ]);
