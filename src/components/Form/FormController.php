...
class FormController extends \Opensitez\Simplicity\Component
{
    private $formManager;
    private $field_types;
    ...
    function addForm($app = [])
    {
        ...
        $data = [
            ...
            'message_class' => '',
            'form_domain' => '',
            'form_action' => '?component=form&page=add_form',
            'form_description' => '',
            'form_editor' => '',
        ];
    ...
    function editForm($app = [])
    {
        ...
        $data = [
            ...
            'form_action' => '?component=form&page=update_form&form_id=' . intval($app['form_id']),
    ...
    function listForms($app = [])
    {
        ...
        $data = [
            'message' => $app['message'] ?? '',
            'rows' => '',
            'add_link' => '?component=form&page=add_form',
        ];
