...
class Folder extends \Opensitez\Simplicity\Component
{
    public $name = "Folders";
    ...
    function get_menus($app = [])
    {
        $menus = [
            "content" => [
                ...
                "children" => [
                    "folder" => ["component" => "folder", "page" => "default", "text" => "Virtual Folders", "category" => "all"],
                ],
            ],
        ...
        if ($indexfiles) {
            ...
            foreach ($indexfiles as $indexfile) {
                ...
                if (file_exists($indexpath)) {
                    ...
                    $retval .= $this->substitute_vars($block_component->render_insert_text($fcontent, $options), $vararrays);
                }
            }
        }
        //exit;
    ...
    public function on_render_page($app)
    {
        ...
        if (is_dir($full_path)) {
            ...
            $rendered_content = $block_component->render_insert_text($fcontent, $options, $app);
